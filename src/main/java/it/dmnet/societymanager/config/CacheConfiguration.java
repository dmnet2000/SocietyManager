package it.dmnet.societymanager.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SocietyManager");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SocietyManager");
        ...
        config.getMapConfigs().put("it.dmnet.societymanager.domain.*", initializeDomainMapConfig(jHipsterProperties));
